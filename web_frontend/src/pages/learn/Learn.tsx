  ...
  return (
    <div className="relative px-7 min-[500px]:px-15 md:px-20 xl:px-40 py-20 md:py-25 lg:py-30  bg-linear-to-t from-[#26065E] to-[#4801ED]">
      ...
      <div className="font-spaceG flex flex-col gap-4 items-center justify-center text-center">
        <h4 className="text-sm sm:text-base font-bold text-blue-200">How it works</h4>
      ...
      <div className="font-spaceG mt-20 text-center backdrop-blur-3xl">
        <p className="text-red-600 md:text-lg p-2 shadow-[0_0_10px_rgba(255,255,255,0.1)]"><b><u>Note:</u></b> Make sure your <i><b>'Transaction ID' is correct</b></i> and you <b><i>pay the 'exact amount'</i></b> before submitting.</p>
      </div>
    </div>
  )
}
