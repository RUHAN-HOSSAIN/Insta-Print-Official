...
const PrintRates = () => {
  return (
    <div className="px-5 min-[500px]:px-10 md:px-15 py-15 sm:py-20 md:py-25 lg:py-30 font-spaceG">
      ...
      <div className="font-roboto flex max-sm:flex-col items-center justify-center gap-10 max-sm:gap-20 mt-20">
        <div className="min-w-70 relative flex flex-col gap-7 border border-gray-300 rounded-xl shadow-lg p-5 w-1/3">
          ...
          <h2 className="font-bold text-[20px] sm:text-[22px] md:text-[24px]">{pricingData[0].mode}</h2>
          <p className="text-md text-gray-700">From <span className="font-bold text-[34px] sm:text-[36px] md:text-[40px] px-2 sm:px-3 lg:px-4 text-blue-500">{pricingData[0].price}</span> per page</p>
        ...
        <div className="min-w-70 relative bg-linear-to-tr from-blue-700 from-30% to-light-blue flex flex-col gap-7 border border-gray-300 rounded-xl shadow-lg p-5 w-1/3">
          ...
          <h2 className="font-bold text-[20px] sm:text-[22px] md:text-[24px] text-white">{pricingData[1].mode}</h2>
          <p className="text-md text-gray-200">From <span className="font-bold text-[34px] sm:text-[36px] md:text-[40px] px-2 sm:px-3 lg:px-4 text-white">{pricingData[1].price}</span> per page</p>
