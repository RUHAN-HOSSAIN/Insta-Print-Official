...
const PaymentMethodsPanel = () => {
  ...
  return (
    <div className="flex flex-col gap-2 sm:mt-7 shadow-[0px_0px_4px_rgba(0,0,0,0.2)] px-5 py-3 border border-gray-300 rounded-lg">
      <h2 className="font-spaceG text-lg font-bold text-blue-600">Pay via (Send Money)</h2>
      <div>
        {paymentMethods.map((method) => (
          <div key={method.medium} className="flex items-center gap-5 my-2 mr-2">
