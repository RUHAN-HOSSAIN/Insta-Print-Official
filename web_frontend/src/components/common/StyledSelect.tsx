  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      <button
        ...
        className={`font-jura flex w-full items-center justify-between gap-3 rounded-lg border bg-white px-3 py-2.5 text-left text-sm text-slate-900 shadow-sm outline-none transition hover:border-blue-400 focus:border-blue-600 focus:ring-2 focus:ring-blue-100 ${error ? "border-red-500 ring-2 ring-red-100" : "border-slate-300"}`}
      >
